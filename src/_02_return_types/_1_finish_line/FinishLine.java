...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		int D = getTotalDistance();
		// 4. Call the hasCrossedFinishLine() method and save what is returned into a
		// variable
		boolean S = hasCrossedFinishLine();
		// 5. If the robot has crossed the finish line...
		if (S == true) {
			JOptionPane.showMessageDialog(null, "The robot finished and traveled " + D + " Pixels");
		}
		else {
			JOptionPane.showMessageDialog(null, "The robot did not fisnish and traveled " + D + " Pixels");
		}
